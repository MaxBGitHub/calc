...
# 257 "calc.c" 3 4
             stdout
# 257 "calc.c"
                   , "subtract_f(a, b) -> subtract_f(%f, %f) -> %f\r\n", a, b, retVal);
      break;
    case TOKEN_MULTIPLY:
      b = float_stack_pop(values);
      a = float_stack_pop(values);
...
# 263 "calc.c" 3 4
             stdout
# 263 "calc.c"
                   , "multiply_f(a, b) -> multiply_f(%f, %f) -> %f\r\n", a, b, retVal);
      break;
    case TOKEN_DIVIDE_1:
    case TOKEN_DIVIDE_2:
      b = float_stack_pop(values);
...
evaluate_postfix(const char *postfix)
{
  ...
  while (postfix[i] != '\0') {
    ...
    if (is_digit_or_floating_point(postfix[i])) {
      ...
      num_str[n] = '\0';
      float_stack_push(&values, strtof(num_str, 
# 325 "calc.c" 3 4
                                               ((void *)0)
# 325 "calc.c"
                                                   ));
...
# 348 "calc.c" 3 4
           stdout
# 348 "calc.c"
                 , "failed to get postfix from shunting yard\r\n");
    free(result);
    return;
  }
  fprintf(
...
# 369 "calc.c" 3 4
         stdout
# 369 "calc.c"
               , "\t\tSimple calculator by Max Bader (services.bader@gmail.com)\r\n");
  fprintf(
# 370 "calc.c" 3 4
         stdout
# 370 "calc.c"
